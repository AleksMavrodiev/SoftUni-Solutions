...
{
    public class HouseRenting : IdentityDbContext
    {
        public HouseRenting(DbContextOptions<HouseRenting> options)
            : base(options)
        {
        ...
        private void SeedHouses()
        {
            ...
            {
                Id = Guid.Parse("70be8ec9-abfe-4eb9-8a86-45d6b036c1d8"),
                Title = "Big House Marina",
                Address = "North London, UK (near the border)",
                Description = "A big house for your whole family. Don't miss to buy a house with three bedrooms.",
                ImageUrl =
                    "https://www.luxury-architecture.net/wpcontent/uploads/2017/12/1513217889-7597-FAIRWAYS-010.jpg",
                PricePerMonth = 2100.00M,
                CreatedOn = System.DateTime.UtcNow,
                CategoryId = DuplexCategory.Id,
                AgentId = Agent.Id,
                RenterId = Guid.Parse(GuestUser.Id)
            };
            ...
            {
                Id = Guid.Parse("b87de45d-e5a8-4098-af9f-ab1e5514e18d"),
                Title = "Grand House",
