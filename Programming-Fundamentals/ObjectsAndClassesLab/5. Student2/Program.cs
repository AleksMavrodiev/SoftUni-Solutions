    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while ((command = Console.ReadLine()) != "end")
            {
                ...
                if (DoesStudentExist(students, firstName, lastName) != null)
                {
                    Student newStudent = DoesStudentExist(students, firstName, lastName);
                    newStudent.Age = age;
        ...
        static Student DoesStudentExist(List<Student> students, string firstName, string lastName)
        {
