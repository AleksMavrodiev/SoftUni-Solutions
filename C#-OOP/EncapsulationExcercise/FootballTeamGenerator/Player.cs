   ...
   public class Player
    {
        ...
        public Player(string name, int endurance, int sprint, int dribble, int shooting, int passing)
        {
            this.Name = name;
        ...
        public double Overall => (this.Endurance + this.Sprint + this.Shooting + this.Dribble + this.Passing) / 5.0;
